...
public class KafkaToHdfs {
    public static void main(String[] args) throws Exception {
        ...
        BucketingSink<String> topic_startSink = new BucketingSink<>("hdfs://home0:9000/logs/topic_start");
        ...
        BucketingSink<String> topic_eventSink = new BucketingSink<>("hdfs://home0:9000/logs/topic_event");
        //创建一个按照时间创建目录的bucketer,默认是yyyy-MM-dd--HH，时区默认是美国时间。这里我都改了，一天创建一次目录，上海时间
